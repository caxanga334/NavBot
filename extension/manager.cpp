...
static inline const char* GetEngineBranchName()
{
...
void CExtManager::OnAllLoaded()
{
	...
	smutils->LogMessage(myself, "Extension fully loaded. Source Engine '%s'. Detected Mod: '%s'", GetEngineBranchName(), m_mod->GetModName());
