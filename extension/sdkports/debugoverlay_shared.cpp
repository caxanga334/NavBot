...
//-----------------------------------------------------------------------------
void NDebugOverlay::EntityBounds(edict_t *pEntity, int r, int g, int b, int a, float flDuration )
{
	auto pCollide = pEntity->GetCollideable();
