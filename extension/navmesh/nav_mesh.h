...
public:
	...
	const std::string* GetPlaceName(const Place place) const;			// returns the place human readable name
	...
	enum class EditSoundType : uint32_t
	{
		...
		SOUND_GENERIC_OFF,
		SOUND_CONNECT_FAIL,
		SOUND_GENERIC_ENABLE,
		SOUND_GENERIC_DISABLE,
		SOUND_WAYPOINT_ADD,
		SOUND_BEGIN_AREA,
		SOUND_END_AREA,
		SOUND_SPLIT_AREA,
		SOUND_GENERIC_TOGGLE,
		SOUND_MOVE_CORNER,
		SOUND_GENERIC_DENIED,
