...
public:
	...
	TaskEventResponseResult<CBaseBot> OnDebugMoveToCommand(CBaseBot* bot, const Vector& moveTo) override;
...
TaskEventResponseResult<CBaseBot> CBaseBotTestTask::OnDebugMoveToCommand(CBaseBot* bot, const Vector& moveTo)
{
