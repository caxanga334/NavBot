...
parser.options.add_argument('--arch-features', type=int, dest='arch_feat', default=0,
                       help='CPU Architecture Settings:-2 = Targeted CPU, -1 = native (gcc/clang), 0 = None, 1 = SSE4, 2 = AVX2')
parser.options.add_argument('--cpu-target', type=str, dest='cpu_target', default=None,
                       help='Target CPU architecture (Linux only)')
