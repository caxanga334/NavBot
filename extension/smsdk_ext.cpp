...
#ifdef SMEXT_CONF_IFACE_WORKAROUND

/** Exposes the extension to Metamod. Alternative Method to avoid conflicts with tier1's CreateInterface */
...
#endif // SMEXT_CONF_IFACE_WORKAROUND
